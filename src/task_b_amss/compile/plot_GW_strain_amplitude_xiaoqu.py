...
## from numerical-relativity outputs and plots it.
##
#################################################
...
## Adapted from standard signal processing examples.
...
def generate_gravitational_wave_amplitude_plot( outdir, figure_outdir, detector_number_i ):
    ...
    omega_cet_l2m1  = 2.0 * math.pi / frequency_cet_l2m1
    omega_cet_l2m2  = 2.0 * math.pi / frequency_cet_l2m2

    if (omega_cet_l2m0 < omega_cet_l2m2):
        omega_cet_l2m0 = omega_cet_l2m2
    if (omega_cet_l2m1 < omega_cet_l2m2):
        omega_cet_l2m1 = omega_cet_l2m2
    if (omega_cet_l2m1m < omega_cet_l2m2):
        omega_cet_l2m1m = omega_cet_l2m2
    if (omega_cet_l2m2m < omega_cet_l2m2):
        omega_cet_l2m2m = omega_cet_l2m2
    '''
    ...
    psi4_l2m2_real_omega_integration       = frequency_filter_integration( psi4_l2m2_real_omega,       psi4_l2m2_real_omega_spectrem,       omega_cet )
    psi4_l2m2_imaginary_omega_integration  = frequency_filter_integration( psi4_l2m2_imaginary_omega,  psi4_l2m2_imaginary_omega_spectrem,  omega_cet )
    ...
    for j in range( len(time_grid) ):
        ...
        GW_h_cross_l2m0_integrand2 = lambda t: GW_h_cross_l2m0_integrant(t, time_grid[j])
